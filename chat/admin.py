...
class CustomUserAdmin(UserAdmin):
    list_display = ['username', 'full_name', 'email', 'is_online', 'last_seen', 'is_email_verified']
    list_filter = ['is_online', 'is_email_verified', 'last_seen', 'date_joined']
...
class ChatAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'chat_type', 'admin', 'participant_count', 'created_at', 'updated_at']
...
class MessageAdmin(admin.ModelAdmin):
    list_display = ['chat', 'sender', 'content_preview', 'message_type', 'timestamp', 'is_read']
...
class TweetAdmin(admin.ModelAdmin):
    list_display = ['user', 'content_preview', 'has_image', 'timestamp', 'like_count', 'comment_count']
    list_filter = ['timestamp']
    search_fields = ['content', 'user__username', 'user__name', 'user__lastname']
    readonly_fields = ['timestamp']
    raw_id_fields = ['user']
...
class CommentAdmin(admin.ModelAdmin):
    list_display = ['user', 'tweet_preview', 'content_preview', 'timestamp', 'parent']
    list_filter = ['timestamp']
...
class StoryAdmin(admin.ModelAdmin):
    list_display = ['user', 'story_type', 'content_preview', 'created_at', 'expires_at', 'is_active', 'view_count', 'like_count', 'reply_count']
    list_filter = ['story_type', 'is_active', 'created_at']
    search_fields = ['user__username', 'content']
    readonly_fields = ['created_at', 'expires_at', 'view_count', 'like_count', 'reply_count']
    raw_id_fields = ['user']
